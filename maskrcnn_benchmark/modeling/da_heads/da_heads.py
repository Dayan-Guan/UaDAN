...
class DomainAdaptationModule(torch.nn.Module):
    ...
    def forward(self, img_features, da_ins_feature, da_ins_labels,
                targets=None, da_img_weight=None, da_ins_weight=None, cls_prob=None, mask_feas=None):
        """
        Arguments:
